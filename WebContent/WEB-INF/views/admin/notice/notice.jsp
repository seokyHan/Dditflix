...
<div class = "bgBox">
  <div class="concord-img-gradient"></div>
    ...
    <div class="main">
		...
		<input type="button" class="btn btn-primary" id="btn" value="등록" onclick="noticeWrite();">
    </div>
     ...
     <tbody>
     	...
     	%>
             ...
             <tr style="cursor:pointer; color:#blue;" onClick="location.href='/Dditflix/admin/notice/nodetail.do?noticeId=<%=noticeList.get(i).getNoticeId()%>'"> 
               <td><%=i+1 %></td>
...
<script>
       ...
       function noticeWrite(){
    	   ...
    	   location.href = "/Dditflix/admin/notice/noinsert.do?userId=<%=user.getUsers_id() %>";
