...
<%
	AdminSalesVO vo = (AdminSalesVO) request.getAttribute("totalSales");
	List<AdminSalesVO> dataList = (List<AdminSalesVO>) request.getAttribute("totalSalesChart");
%>	
	...
	<div class="gridBox">
		<div class="monitoringContentsBox">
			<h3 class="monitoringTitle">월별 총 매출 현황</h3>
	...
	<script type="text/javascript">
		...
		function drawChart() {
			...
			%>
 					list.push([ "<%=months%>", parseInt("<%=total%>") ]);
			<%
			}
			%>	
