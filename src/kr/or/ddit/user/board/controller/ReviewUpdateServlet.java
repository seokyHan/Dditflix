 ...
 */
@WebServlet("/user/board/update.do")
...
//		bv.setRvId(rvId);
		...
		request.getRequestDispatcher("/WEB-INF/views/user/board/boardUpdate.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String redirectUrl = request.getContextPath() + "/user/board/board.do?msg=" + URLEncoder.encode(msg, "UTF-8");
